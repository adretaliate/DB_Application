...
<%
	...
	%><tr><td><%=prod.get(0)%></td><td><%=prod.get(1)%></td><td><%=prod.get(2)%></td> <td><button type="submit" name="delete" value="<%=prod.get(3)%> <%=prod.get(4)%>">Delete item</button></td><td><button type="submit" name="edit" value="<%=prod.get(3)%> <%=prod.get(4)%>">Edit item</button></td></tr><%
